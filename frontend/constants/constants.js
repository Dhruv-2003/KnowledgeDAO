...
export const ArticleManager_ABI = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint32",
        name: "_personalArticleId",
        type: "uint32",
      },
    ],
    name: "getPersonalResearch",
    outputs: [
      {
        components: [
          {
  ...
  },
  {
    inputs: [
      {
        internalType: "uint32",
        name: "_VerfiedArticleId",
        type: "uint32",
      },
    ],
    name: "getVerifiedResearch",
    outputs: [
      {
        components: [
          {
  ...
  },
  {
    ...
    name: "personalArticlesPublished",
    outputs: [
      {
        internalType: "address",
        name: "publisher",
